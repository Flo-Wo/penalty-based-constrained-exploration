...
from agent import (
    LinearSoftmaxPolicy,
    PolicyGradientPenaltyMethod,
    ProximalPointPolicyGradientPenaltyMethod,
)
...
for global_task_id in task_iterator:
    ...
    experiment = Experiment(
        name=name,
        agent=ProximalPointPolicyGradientPenaltyMethod,
        ...
        agent_kwargs={
            ...
            "inner_T": hparams.get("inner_T", 1),
            "reg_param": hparams.get("reg_param", 0.0),
        },
